...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("desk_tip", "Uw apparaat is bereikbaar met dit ID en wachtwoord."),
        ("Password", "Wachtwoord"),
        ("Ready", "Verbonden"),
        ("Established", "Opgezet"),
        ("connecting_status", "Verbinding maken met het ASCI RustDesk netwerk..."),
        ...
        ("Insert Lock", "Vergrendeling Invoeren"),
        ("Refresh", "Vernieuwen"),
        ...
        ("install_tip", "Door UAC-beperkingen lukt het niet altijd om d op afstand de muis en het toetsenbord te bedienen, of het scherm over te nemen. Klik op de knop hieronder om ASCI RustDesk op het systeem te installeren om dit probleem te voorkomen."),
        ("Click to upgrade", "Klik voor upgrade"),
        ("Click to download", "Klik om te downloaden"),
        ("Click to update", "Klik om bij te werken"),
        ("Configure", "Configureren"),
        ("config_acc", "Om uw apparaat op afstand te kunnen bedienen, moet u ASCI RustDesk toestemming voor \"toegankelijkheid\" geven."),
        ("config_screen", "Om op afstand toegang te krijgen tot uw apparaat, moet u ASCI RustDesk toestemming voor \"schermregistratie\" geven."),
        ...
        ("android_input_permission_tip1", "Om ervoor te zorgen dat een extern apparaat uw Android-apparaat kan besturen via muis of aanraking, moet u ASCI RustDesk toestaan om de \"Toegankelijkheid\" service te gebruiken."),
        ("android_input_permission_tip2", "Ga naar de volgende pagina met systeeminstellingen, zoek en ga naar [Geïnstalleerde Services], schakel de service [ASCI RustDesk Input] in."),
        ...
        ("Language", "Taal"),
        ("Keep RustDesk background service", "ASCI RustDesk achtergronddienst behouden"),
        ...
        ("Show RustDesk", "Toon ASCI RustDesk"),
        ("This PC", "Deze PC"),
        ("or", "of"),
        ...
        ("Accept sessions via both", "Sessies accepteren via beide"),
        ...
        ("config_input", "Om uw apparaat met het toetsenbord te kunnen bedienen, moet u ASCI RustDesk de rechten \"Invoer vastleggen\" geven."),
        ("config_microphone", "Om op afstand te kunnen chatten, moet u ASCI RustDesk 'Audio opnemen' rechten geven."),
        ...
        ("still_click_uac_tip", "De gebruiker op afstand moet altijd bevestigen via het UAC-venster van de werkende ASCI RustDesk."),
        ...
        ("FPS", "FPS"),
        ("Auto", "Auto"),
        ("Other Default Options", "Overige Standaardopties"),
        ...
        ("View Mode", "Weergave Modus"),
        ("login_linux_tip", "Toegang tot het externe Linux-account"),
        ("verify_rustdesk_password_tip", "Bevestiging wachtwoord ASCI RustDesk"),
        ("remember_account_tip", "Herinner dit account"),
        ("os_account_desk_tip", "Dit account wordt gebruikt om toegang te krijgen tot het externe besturingssysteem en de sessie in onbeheerde modus te activeren."),
        ...
        ("scam_text1", "Als u aan de telefoon bent met iemand die u NIET kent EN VERTROUWT en die u heeft gevraagd om ASCI RustDesk te gebruiken en de service te starten, ga dan niet verder en hang onmiddellijk op."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Upgrade ASCI RustDesk Server Pro naar versie {} of nieuwer!"),
        ...
        ("selinux_tip", "SELinux is ingeschakeld op dit apparaat, waardoor ASCI RustDesk mogelijk niet goed functioneert als een gecontroleerde kant."),
        ...
        ("id_input_tip", "Je kunt een ID, een direct IP of een domein met een poort (<domein>:<poort>) invoeren.\n\nAls je toegang wilt tot een apparaat op een andere server, voeg dan het serveradres toe (<id>@<server_adres>?key=<key_value>), bijvoorbeeld \n9123456234@192.168.16.1:21117?key=5Qbwsde3unUcJBtrx9ZkvUmwFNoExHzpryHuPUdqlWM=.\n\nAls je toegang wilt tot een apparaat op de openbare server, voer dan \"<id>@public\" in. Voor de openbare server is de sleutel niet nodig."),
        ...
        ("allow-only-conn-window-open-tip", "Alleen verbindingen toestaan als het ASCI RustDesk-venster geopend is"),
        ...
        ("floating_window_tip", "Helpt ASCI RustDesk op de achtergrond actief te houden"),
        ...
        ("About RustDesk", "Over ASCI RustDesk"),
