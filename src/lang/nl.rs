...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("desk_tip", "Uw bureaublad is bereikbaar met dit ID en wachtwoord."),
        ("Password", "Wachtwoord"),
        ("Ready", "Klaar"),
        ("Established", "Opgezet"),
        ...
        ("install_tip", "Door UAC-beperkingen is het niet altijd mogelijk om op afstand de muis en het toetsenbord te bedienen, of het scherm over te nemen. Klik op de knop hieronder om ASCI RustDesk op het systeem te installeren om dit probleem te voorkomen."),
        ("Click to upgrade", "Klik voor upgrade"),
        ("Click to download", "Klik om te downloaden"),
        ("Click to update", "Klik om bij te werken"),
        ("Configure", "Configureren"),
        ("config_acc", "Om uw bureaublad op afstand te kunnen bedienen, moet u ASCI RustDesk toestemming voor \"toegankelijkheid\" geven."),
        ("config_screen", "Om op afstand toegang te krijgen tot uw bureaublad, moet u ASCI RustDesk toestemming voor \"schermregistratie\" geven."),
        ...
        ("config_input", "Om het externe bureaublad vanaf het toetsenbord te kunnen bedienen, moet u ASCI RustDesk de rechten \"Invoerbewaking\" geven."),
