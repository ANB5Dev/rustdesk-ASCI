...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("not_ready_status", "Niet verbonden, controleer de netwerkverbinding"),
        ...
        ("wayland_experiment_tip", "Wayland ondersteuning is slechts experimenteel. Gebruik alstublieft X11 als u onbeheerde toegang nodig hebt."),
        ...
        ("empty_favorite_tip", "Nog geen favoriete apparaten op afstand."),
        ("empty_lan_tip", "Nog geen apparaten ontdekt op dit LAN."),
        ("empty_address_book_tip", "Nog geen externe apparaten in uw adresboek."),
        ...
        ("id_input_tip", "U kunt een ID, een direct IP of een domein met poort (<domein>:<poort>) invoeren.\n\nAls u toegang wilt tot een apparaat op een andere server, voeg dan serveradres en public key toe (<id>@<server_adres>?key=<key_value>), bijvoorbeeld \n9123456234@192.168.16.1:21117?key=5Qbwsde3unUcJBtrx9ZkvUmwFNoExHzpryHuPUdqlWM=."),
